...
func init() {
	...
	beego.GlobalControllerRouter["beego_project_test/controllers:GooseDbVersionController"] = append(beego.GlobalControllerRouter["beego_project_test/controllers:GooseDbVersionController"],
		beego.ControllerComments{
			Method:           "Post",
			Router:           `/`,
			AllowHTTPMethods: []string{"post"},
	...
	beego.GlobalControllerRouter["beego_project_test/controllers:ObjectController"] = append(beego.GlobalControllerRouter["beego_project_test/controllers:ObjectController"],
		beego.ControllerComments{
			Method:           "Post",
			Router:           `/`,
			AllowHTTPMethods: []string{"post"},
